...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14-Out-2020 às 13:19
...
--
ALTER TABLE `itemorcamentoalimento`
  MODIFY `numeroItem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de tabela `itemorcamentobebida`
--
ALTER TABLE `itemorcamentobebida`
  MODIFY `numeroItem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `orcamento`
  MODIFY `idOrcamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
