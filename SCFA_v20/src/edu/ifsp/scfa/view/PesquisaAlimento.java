 ...
 * @author Programar
 */
public class PesquisaAlimento extends javax.swing.JDialog {
    ...
    public PesquisaAlimento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        carregarLista();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquisar Alimentos:");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Relação de Alimento", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Unicode MS", 1, 18))); // NOI18N
        ...
        jTableAlimentoPesquisa.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableAlimentoPesquisaMouseClicked(evt);
            }
        });
    ...
    private void btCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarActionPerformed
        ...
        if (!txtQuantidade.getText().equals("")) {
            ...
            Alimento Alimento = listaAlimentos.get(jTableAlimentoPesquisa.getSelectedRow());
            ItemOrcamentoAlimento item = new ItemOrcamentoAlimento();
            item.setAlimento(Alimento);
            item.setQuantidade(Integer.parseInt(txtQuantidade.getText()));
            item.setOrcamento(orcamento);
            tfValorUnitario.setText(String.format("%.2f", Alimento.getPrecoUnitario()));//exibo no campo de valor unitario
    ...
    private void jTableAlimentoPesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableAlimentoPesquisaMouseClicked
        // TODO add your handling code here:
        Alimento b = listaAlimentos.get(jTableAlimentoPesquisa.getSelectedRow());
        tfValorUnitario.setText(String.format("%.2f", b.getPrecoUnitario()));
    }//GEN-LAST:event_jTableAlimentoPesquisaMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaAlimento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaAlimento dialog = new PesquisaAlimento(new javax.swing.JFrame(), true);
