 ...
 * @author Programar
 */
public class PesquisaUtensilio extends javax.swing.JDialog {

    /**
     * Creates new form PesquisaCliente
     */
    private ItemOrcamentoUtensilioDAO dao = new ItemOrcamentoUtensilioDAO();
    ...
    public PesquisaUtensilio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        carregarLista();
    ...
    public void atualizaTabela() {
        DefaultTableModel dtm = (DefaultTableModel) jTableUtensilioPesquisa.getModel(); // manipulador de tabela DefaultTableModel
        dtm.setNumRows(0);//apagando todas as linhas / o zero serva para apagar as linhas "é muito rapido"
        for (Utensilio b : listaUtensilios) {
            //String.format("%.2f",f.getPrecoUnitario()) -> mostra com duas casa apos a virgula
            dtm.addRow(new Object[]{b.getNome(), b.getPrecoUnitario(), b.getTipoUtensilio()}); // Object é um vetor ou coleção com ele não pecisa converter
        }

    }

    public void pesquisar() {
        String str = "from Utensilio b ";
    ...
    private void initComponents() {
        ...
        jTableUtensilioPesquisa = new javax.swing.JTable();
        ...
        jLabel1.setText("Pesquisar Materiais:");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Relação de Material", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Unicode MS", 1, 18))); // NOI18N

        jTableUtensilioPesquisa.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Nome", "Mão de Obra", "Tipo"
            }
        ) {
        ...
        jTableUtensilioPesquisa.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableUtensilioPesquisaMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableUtensilioPesquisa);
        if (jTableUtensilioPesquisa.getColumnModel().getColumnCount() > 0) {
            jTableUtensilioPesquisa.getColumnModel().getColumn(0).setResizable(false);
            jTableUtensilioPesquisa.getColumnModel().getColumn(1).setResizable(false);
            jTableUtensilioPesquisa.getColumnModel().getColumn(1).setPreferredWidth(40);
            jTableUtensilioPesquisa.getColumnModel().getColumn(2).setResizable(false);
        }
        ...
        lbValorUnitario.setText("Mão de Obra R$:");
    ...
    private void btCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarActionPerformed
        ...
        if (!txtQuantidade.getText().equals("")) {
            ...
            Utensilio Utensilio = listaUtensilios.get(jTableUtensilioPesquisa.getSelectedRow());
            ItemOrcamentoUtensilio item = new ItemOrcamentoUtensilio();
            item.setUtensilio(Utensilio);
            item.setQuantidade(Integer.parseInt(txtQuantidade.getText()));
            item.setOrcamento(orcamento);
            tfValorUnitario.setText(String.format("%.2f", Utensilio.getPrecoUnitario()));//exibo no campo de valor unitario
    ...
    private void jTableUtensilioPesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableUtensilioPesquisaMouseClicked
        // TODO add your handling code here:
        Utensilio b = listaUtensilios.get(jTableUtensilioPesquisa.getSelectedRow());
        tfValorUnitario.setText(String.format("%.2f", b.getPrecoUnitario()));
    }//GEN-LAST:event_jTableUtensilioPesquisaMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaUtensilio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaUtensilio dialog = new PesquisaUtensilio(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTableUtensilioPesquisa;
