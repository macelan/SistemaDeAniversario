 ...
 * @author macel
 */
public class VisaoUsuario extends javax.swing.JDialog {

    /**
     * Creates new form VisaoUsuario
     */
    //private final UsuarioDAO usuarioDAO;// pode ser final, não vou modificar mais ele
    ...
    public void atualizaTabela() {
        DefaultTableModel dtm = (DefaultTableModel) jTableUsuario.getModel(); // manipulador de tabela DefaultTableModel
        dtm.setNumRows(0);//apagando todas as linhas / o zero serva para apagar as linhas "é muito rapido"
        for (Usuario f : listaUsuarios) {
            //String.format("%.2f",f.getPrecoUnitario()) -> mostra com duas casa apos a virgula
            dtm.addRow(new Object[]{f.getNome(), f.getLogin()}); // Object é um vetor ou coleção com ele não pecisa converter
        }
    ...
    private void trataEdicao(boolean editando) {
        ...
        txtSenhaConfirma.setEnabled(editando);
        //btnPesquisar.setEditable(editando);
        txtLocalizar.setEnabled(editando);
        jTableUsuario.setEnabled(!editando);
    }

    public boolean validaCampos() {
        if (!(txtNome.getText().length() > 0)) {
            JOptionPane.showMessageDialog(null, "Informe o Nome da Usuario.");
            return false;
        }
        return true;
    }
    ...
    public void carregarLista() {
        listaUsuarios = controle.listarTodos();
    }

    public void pesquisar() {
        String str = "from Usuario f ";
    ...
    public void pesquisarDinamico(String comando) {
        this.listaUsuarios = controle.pesquisarUsuarios(comando);
    }

    public VisaoUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        carregarLista();
        atualizaTabela();
    ...
    public void vincularCampos() {
        Usuario b = listaUsuarios.get(jTableUsuario.getSelectedRow());// pega a linha da tabela
        txtNome.setText(b.getNome());
        txtSenha.setText(b.getSenha()); //Pega converte em String
        txtSenhaConfirma.setText(b.getSenha()); //Pega converte em String
        txtLogin.setText(b.getLogin());
    ...
    public boolean existCamposVazio() {
        ...
        if (txtLogin.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "O campo LOGIN deve ser Prenchido");
            return true;
        }
        if (txtSenha.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "O campo SENHA deve ser Prenchido");
            //JOptionPane.showMessageDialog(null, "Informe a SENHA!", "Alerta", JOptionPane.WARNING_MESSAGE);
            return true;
        }
        if (txtSenhaConfirma.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "O campo SENHA de Confirmação deve ser Prenchido");
            return true;
        }
    ...
    private void initComponents() {
        ...
        painelDados.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Usuário", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Unicode MS", 1, 18))); // NOI18N
        ...
        dataLabel3.setText("Confirma Senha:");

        txtSenhaConfirma.setFont(new java.awt.Font("Arial Unicode MS", 0, 14)); // NOI18N
            ...
            .addGroup(painelDadosLayout.createSequentialGroup()
                ...
                .addGroup(painelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(painelDadosLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtSenhaConfirma, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        setSize(new java.awt.Dimension(825, 566));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (jTableUsuario.getSelectedRow() < 0) {
            ...
            Usuario b = listaUsuarios.get(jTableUsuario.getSelectedRow());
            controle.remover(b);
        }
        carregarLista();
        atualizaTabela();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        boolean ret = controle.listarPorLogin(txtLogin.getText());
        ...
        if (!existCamposVazio()) {
            if (!ret) {
                if (txtSenha.getText().equals(txtSenhaConfirma.getText())) {
                    ...
                    JOptionPane.showMessageDialog(null, "As senhas não são iguais!", "Tente Novamente.", JOptionPane.ERROR_MESSAGE);
                    txtSenha.setText("");
                    txtSenhaConfirma.setText("");
                    txtNome.requestFocus();
                }
            } else {
                JOptionPane.showMessageDialog(null, "Login Já Existe Favor trocar! Digite novamente", "Alerta", JOptionPane.WARNING_MESSAGE);
                txtLogin.setText("");
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (jTableUsuario.getSelectedRow() < 0) {
            ...
            f = listaUsuarios.get(jTableUsuario.getSelectedRow());
            trataEdicao(true);
            txtNome.requestFocus();
        }
        carregarLista();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisaoUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VisaoUsuario dialog = new VisaoUsuario(new javax.swing.JFrame(), true);
