...
import edu.ifsp.scfa.control.UtensilioDAO;
 ...
 * @author macel
 */
public class VisaoUtensilio extends javax.swing.JDialog {

    /**
     * Creates new form VisaoUtensilio
     */
    //private final UtensilioDAO utensilioDAO;// pode ser final, não vou modificar mais ele
    private UtensilioDAO controle = new UtensilioDAO();
    private List<Utensilio> listautensilios = new ArrayList();
    //DateFormat df = new SimpleDateFormat("dd/MM/yyyy"); // o mes tem que ser maiusculo
    Utensilio b = new Utensilio();

    public void atualizaTabela() {
        DefaultTableModel dtm = (DefaultTableModel) jTableUtensilio.getModel(); // manipulador de tabela DefaultTableModel
        dtm.setNumRows(0);//apagando todas as linhas / o zero serva para apagar as linhas "é muito rapido"
        for (Utensilio f : listautensilios) {
            //String.format("%.2f",f.getPrecoUnitario()) -> mostra com duas casa apos a virgula
            dtm.addRow(new Object[]{f.getNome(),String.format("%.2f",f.getPrecoUnitario()), f.getTipoUtensilio() }); // Object é um vetor ou coleção com ele não pecisa converter
        }
    ...
    private void trataEdicao(boolean editando) {
        ...
        jTableUtensilio.setEnabled(!editando);
    }

    public boolean validaCampos() {
        if (!(txtNome.getText().length() > 0)) {
            JOptionPane.showMessageDialog(null, "Informe o Nome da Utensilio.");
            return false;
        }
        return true;
    }
    ...
    public void limparCampos() {
        ...
        jComboBoxUtensilio.setSelectedIndex(0);
    }

    public void carregarLista() {
        listautensilios = controle.listarTodos();
    }

    public void pesquisar() {
        String str = "from Utensilio f ";
    ...
    public void pesquisarDinamico(String comando) {
        this.listautensilios = controle.pesquisarUtensilios(comando);
    }

    public VisaoUtensilio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        carregarLista();
        atualizaTabela();
    ...
    public void vincularCampos() {
        Utensilio b = listautensilios.get(jTableUtensilio.getSelectedRow());// pega a linha da tabela
        txtNome.setText(b.getNome());
        txtPrecoUnitario.setText((String.format("%.2f", b.getPrecoUnitario()))); //Pega converte em String
        jComboBoxUtensilio.setSelectedItem(b.getTipoUtensilio()); // pega o utensilio no comboBox
    ...
    private void initComponents() {
        ...
        jComboBoxUtensilio = new javax.swing.JComboBox<>();
        ...
        jTableUtensilio = new javax.swing.JTable();
        ...
        painelDados.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados da Utensilio", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Unicode MS", 1, 18))); // NOI18N

        jLabel10.setFont(new java.awt.Font("Arial Unicode MS", 1, 14)); // NOI18N
        jLabel10.setText("Nome do Materias:");
        ...
        dataLabel2.setText("Tipo de Material:");

        jComboBoxUtensilio.setFont(new java.awt.Font("Arial Unicode MS", 0, 14)); // NOI18N
        jComboBoxUtensilio.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Escolha o tipo", "Talher", "Louça", "Toalha", "Brinquedo" }));
        jComboBoxUtensilio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxUtensilioActionPerformed(evt);
            }
        });
                ...
                .addGroup(painelDadosLayout.createSequentialGroup()
                    ...
                    .addGroup(painelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(painelDadosLayout.createSequentialGroup()
                            ...
                            .addGap(274, 274, 274)
                            .addComponent(jComboBoxUtensilio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGap(0, 18, Short.MAX_VALUE)))
        );
        ...
        jTableUtensilio.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTableUtensilio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableUtensilioMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableUtensilio);
        if (jTableUtensilio.getColumnModel().getColumnCount() > 0) {
            jTableUtensilio.getColumnModel().getColumn(0).setResizable(false);
            jTableUtensilio.getColumnModel().getColumn(1).setResizable(false);
            jTableUtensilio.getColumnModel().getColumn(2).setResizable(false);
        }
    ...
    private void jComboBoxUtensilioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxUtensilioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jComboBoxUtensilioActionPerformed
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (!txtNome.getText().equals("")) {
            if (!txtPrecoUnitario.getText().equals("")) {
                if (jComboBoxUtensilio.getSelectedIndex() != 0) {
                    b.setNome(txtNome.getText());
                    b.setPrecoUnitario(Double.parseDouble(txtPrecoUnitario.getText().replace(",", ".")));
                    b.setTipoUtensilio(jComboBoxUtensilio.getSelectedItem().toString());
                    ...
                    JOptionPane.showMessageDialog(null, "Informe o Tipo de utensilio!", "Alerta", JOptionPane.WARNING_MESSAGE);
                }
            } else {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (jTableUtensilio.getSelectedRow() < 0) {
            ...
            Utensilio b = listautensilios.get(jTableUtensilio.getSelectedRow());
            controle.remover(b);
        }
        carregarLista();
        atualizaTabela();
    ...
    private void jTableUtensilioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableUtensilioMouseClicked
        // TODO add your handling code here:
        vincularCampos();// vincula campos
    }//GEN-LAST:event_jTableUtensilioMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisaoUtensilio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VisaoUtensilio dialog = new VisaoUtensilio(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox<String> jComboBoxUtensilio;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel10;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JTable jTableUtensilio;
