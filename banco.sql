...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04-Mar-2021 às 17:27
...
CREATE TABLE `orcamento` (
  ...
  `valorTotalMaoDeObra` double DEFAULT NULL,
...
INSERT INTO `orcamento` (`idOrcamento`, `dataEvento`, `dataOrcamento`, `horaEvento`, `nomeDoAniversariante`, `quantidadeAlimento`, `quantidadeBebida`, `quantidadeUtensilio`, `status`, `valorTotal`, `valorTotalMaoDeObra`, `idCliente`) VALUES
(1, '2020-10-15', '2020-10-14', '15:15:00', 'Jorge', 30, 30, 54, 'Pendente', 8054, 21, 4),
(2, '2020-10-16', '2020-10-14', '20:30:00', 'Marilda', 30, 22, 103, 'Pendente', 190.5, 106.7, 5),
(3, '2020-10-23', '2020-10-14', '15:50:00', 'João', 30, 30, 21, 'Pendente', 164, 68.5, 4),
(4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL),
(5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL),
(6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL),
(7, '2020-10-27', '2020-10-14', '15:50:00', 'Marco', 30, 20, 30, 'Pendente', 147.5, 111, 7),
(8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL),
(9, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL);
...
--
ALTER TABLE `alimento`
  MODIFY `idAlimento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `itemorcamentoalimento`
  MODIFY `numeroItem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de tabela `itemorcamentobebida`
--
ALTER TABLE `itemorcamentobebida`
  MODIFY `numeroItem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `orcamento`
  MODIFY `idOrcamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
